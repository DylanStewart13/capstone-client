    ...
    render() {
        ...
        return (
            <div className="auth-wrapper">
                ...
                <div className="right">
                    <div className="header">Fullstack Quiz</div>
                    <div className="sub-header">Welcome to Fullstack Quiz</div>
                    {page}
                    <div className="new" onClick={this.changeTab}>{this.state.tab === 'signin' ? 'New to Fullstack Quiz? Sign up here' : 'Already have an account? Sign in'}</div>
                </div>
            </div>
        )
    }

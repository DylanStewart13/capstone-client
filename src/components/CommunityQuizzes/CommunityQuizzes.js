                        ...
                        {this.state.quizzes.map((quiz, idx) => (
                            <div key={idx} className="quiz-card card">
                                ...
                                <div className="top-section">
                                    <div className="likes">{quiz.likes} <img style={{ cursor: 'pointer', padding: '5px' }} onClick={() => this.likeQuiz(quiz._id)} src="https://cdn0.iconfinder.com/data/icons/small-n-flat/24/678087-heart-512.png" alt="" /></div>
                                </div>
                            </div>
                        ))}
                    </div>
